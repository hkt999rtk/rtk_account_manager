...
var (
	...
	ErrClaimLifecycleBound            = errors.New("claim is bound to a video cloud lifecycle")
	ErrClaimLifecycleCheckUnavailable = errors.New("video cloud lifecycle check is unavailable")
	ErrCloudManagedPresence           = errors.New("cloud-managed device presence cannot be set by a human")
	ErrReservedDeviceMetadata         = errors.New("device metadata contains a service-owned key")
