...
func run(args []string, stdout, stderr io.Writer) error {
	...
	flags.StringVar(&opts.SMTPHost, "smtp-host", opts.SMTPHost, "SMTP host to record as optional evidence")
	flags.StringVar(&opts.SMTPFrom, "smtp-from", opts.SMTPFrom, "SMTP sender address to record as optional evidence")
