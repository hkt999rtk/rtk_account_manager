...
- `rtk_account_manager/cmd/server`: `TestServiceRegistrationMTLSDrivesCatalogProductAndRun`
- `rtk_account_manager/cmd/server`: `TestServiceRegistrationTLSHandshakeAndCRLBlocksRevokedClient`
...
- `rtk_account_manager/internal/api`: `TestConfigureVideoPresenceValidatesInternalOrigin/URL_credentials`
- `rtk_account_manager/internal/api`: `TestConfigureVideoPresenceValidatesInternalOrigin/URL_path`
- `rtk_account_manager/internal/api`: `TestConfigureVideoPresenceValidatesInternalOrigin/URL_query`
- `rtk_account_manager/internal/api`: `TestConfigureVideoPresenceValidatesInternalOrigin/disabled`
- `rtk_account_manager/internal/api`: `TestConfigureVideoPresenceValidatesInternalOrigin/missing_token`
- `rtk_account_manager/internal/api`: `TestConfigureVideoPresenceValidatesInternalOrigin/token_without_origin`
...
- `rtk_account_manager/internal/api`: `TestEntitlementSnapshotRouteIsGatedAndAuthenticated/disabled`
- `rtk_account_manager/internal/api`: `TestEntitlementSnapshotRouteIsGatedAndAuthenticated/enabled_requires_auth`
- `rtk_account_manager/internal/api`: `TestEntitlementSnapshotRouteIsGatedAndAuthenticated`
- `rtk_account_manager/internal/api`: `TestEventOnlyReadinessExpiresStaleOnlineProjection/expired_observation`
- `rtk_account_manager/internal/api`: `TestEventOnlyReadinessExpiresStaleOnlineProjection/fresh_observation`
- `rtk_account_manager/internal/api`: `TestEventOnlyReadinessExpiresStaleOnlineProjection/future_observation`
- `rtk_account_manager/internal/api`: `TestEventOnlyReadinessExpiresStaleOnlineProjection/missing_observation`
- `rtk_account_manager/internal/api`: `TestEventOnlyReadinessExpiresStaleOnlineProjection`
...
- `rtk_account_manager/internal/api`: `TestHTTPVideoPresenceReaderDistinguishesAbsentDeviceFromMissingRoute`
- `rtk_account_manager/internal/api`: `TestHTTPVideoPresenceReaderRejectsRedirectAndOversizedSnapshot`
- `rtk_account_manager/internal/api`: `TestHTTPVideoPresenceReaderUsesInternalBearerAndDecodesSnapshot`
...
- `rtk_account_manager/internal/api`: `TestIntegrationAdminReconcilesUncommittedTransferFence`
...
- `rtk_account_manager/internal/api`: `TestIntegrationProvisioningStateUsesLiveOwnerPresence`
- `rtk_account_manager/internal/api`: `TestIntegrationQuotaRaiseValidationAndDefaultApproval`
- `rtk_account_manager/internal/api`: `TestIntegrationReadinessIgnoresOlderDeactivationGeneration`
- `rtk_account_manager/internal/api`: `TestIntegrationRegisterLoginRefreshAndLogout`
- `rtk_account_manager/internal/api`: `TestIntegrationRegisteredPluginReachesProductFactoryAndClaimGrant`
...
- `rtk_account_manager/internal/api`: `TestInternalDevicePresenceEventProjectsAndReplaysIdempotently`
- `rtk_account_manager/internal/api`: `TestInternalDevicePresenceEventRequiresAuthAndValidEnvelope`
...
- `rtk_account_manager/internal/api`: `TestLivePresenceOverridesStaleRegistryProjection/current_owner`
- `rtk_account_manager/internal/api`: `TestLivePresenceOverridesStaleRegistryProjection/identity_mismatch`
- `rtk_account_manager/internal/api`: `TestLivePresenceOverridesStaleRegistryProjection/missing_owner_despite_online_bit`
- `rtk_account_manager/internal/api`: `TestLivePresenceOverridesStaleRegistryProjection/owner_gone`
- `rtk_account_manager/internal/api`: `TestLivePresenceOverridesStaleRegistryProjection/source_unavailable`
- `rtk_account_manager/internal/api`: `TestLivePresenceOverridesStaleRegistryProjection`
...
- `rtk_account_manager/internal/api`: `TestProductServiceApplyHTTPPreservesAuthenticatedScopeAndPagesPast250`
- `rtk_account_manager/internal/api`: `TestProductServiceApplyHTTPRejectsInvalidAndConflictingRequests`
- `rtk_account_manager/internal/api`: `TestProductServiceApplyRoutesRequireFeatureGateAndAuthentication/disabled`
- `rtk_account_manager/internal/api`: `TestProductServiceApplyRoutesRequireFeatureGateAndAuthentication/enabled_requires_auth`
- `rtk_account_manager/internal/api`: `TestProductServiceApplyRoutesRequireFeatureGateAndAuthentication`
...
- `rtk_account_manager/internal/api`: `TestReadinessFromProjectionStates/activation_succeeded_after_old_presence_was_cleared`
...
- `rtk_account_manager/internal/api`: `TestReadinessSourcesExposeProjectedPresenceObservationTime`
...
- `rtk_account_manager/internal/api`: `TestTransferFenceCancellationRequiresAuthenticatedAcknowledgement`
- `rtk_account_manager/internal/api`: `TestTransferFenceLookupRequiresAuthenticatedExactBinding`
- `rtk_account_manager/internal/api`: `TestTransferFenceRequiresAuthenticatedDurableReceipt`
...
- `rtk_account_manager/internal/api`: `TestWriteStoreErrorProtectsServiceOwnedDeviceState/cloud-managed_presence`
- `rtk_account_manager/internal/api`: `TestWriteStoreErrorProtectsServiceOwnedDeviceState/reserved_metadata`
- `rtk_account_manager/internal/api`: `TestWriteStoreErrorProtectsServiceOwnedDeviceState`
...
- `rtk_account_manager/internal/channel`: `TestProvisionGrantTupleValidation`
...
- `rtk_account_manager/internal/channel`: `TestValidateAndDecodeAcceptsEachMessageType/DeviceEntitlementSnapshotFailed`
- `rtk_account_manager/internal/channel`: `TestValidateAndDecodeAcceptsEachMessageType/DeviceEntitlementSnapshotRequested`
- `rtk_account_manager/internal/channel`: `TestValidateAndDecodeAcceptsEachMessageType/DeviceEntitlementSnapshotSucceeded`
...
- `rtk_account_manager/internal/config`: `TestProductGrantWritesRequireDirectAuthenticatedDelivery/bus_broker`
- `rtk_account_manager/internal/config`: `TestProductGrantWritesRequireDirectAuthenticatedDelivery/credential_origin`
- `rtk_account_manager/internal/config`: `TestProductGrantWritesRequireDirectAuthenticatedDelivery/log_broker`
- `rtk_account_manager/internal/config`: `TestProductGrantWritesRequireDirectAuthenticatedDelivery/missing_origin`
- `rtk_account_manager/internal/config`: `TestProductGrantWritesRequireDirectAuthenticatedDelivery/missing_token`
- `rtk_account_manager/internal/config`: `TestProductGrantWritesRequireDirectAuthenticatedDelivery`
...
- `rtk_account_manager/internal/database`: `TestAuditCollisionRollsBackConsolidation`
- `rtk_account_manager/internal/database`: `TestAuditConsolidationPreservesHistoryAndDomains`
...
- `rtk_account_manager/internal/database`: `TestTenantRetirementRefusesUnmappedIdentity`
...
- `rtk_account_manager/internal/emaildelivery`: `TestRendererRejectsRetiredTenantActivation`
...
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/empty`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/malformed`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/not_activated`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/oversized`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/unexpected_201`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/wrong_account_device`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/wrong_activity`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/wrong_device`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/wrong_organization`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting/wrong_status`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRejectsUnmatchedActivationReceiptWithoutProjecting`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRetriesSnapshotAfterReceiverCommitsButReturnsUnavailable`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherRetriesTransientHTTPWithoutProjecting`
- `rtk_account_manager/internal/lifecyclehttp`: `TestPublisherSendsEntitlementSnapshotByPUTAndProjectsResult`
...
- `rtk_account_manager/internal/store`: `TestClaimLifecycleBound/activated`
- `rtk_account_manager/internal/store`: `TestClaimLifecycleBound/claim_only`
- `rtk_account_manager/internal/store`: `TestClaimLifecycleBound/deactivated_still_retains_cloud_identity`
- `rtk_account_manager/internal/store`: `TestClaimLifecycleBound/failed_may_have_partial_side_effects`
- `rtk_account_manager/internal/store`: `TestClaimLifecycleBound/null`
- `rtk_account_manager/internal/store`: `TestClaimLifecycleBound/pending`
- `rtk_account_manager/internal/store`: `TestClaimLifecycleBound`
...
- `rtk_account_manager/internal/store`: `TestClaimTransferRejectsCloudBoundDeviceWithoutMovingAccountRows`
- `rtk_account_manager/internal/store`: `TestClaimTransferReservationIDIsStablePerClaimVersion`
...
- `rtk_account_manager/internal/store`: `TestDeviceEntitlementSnapshotsPinGrantAndCommitAuditWithOutbox`
...
- `rtk_account_manager/internal/store`: `TestDeviceTransferFenceReconciliationCancelsOnlyUncommittedGeneration`
...
- `rtk_account_manager/internal/store`: `TestHasVideoCloudIdentity`
...
- `rtk_account_manager/internal/store`: `TestLegacyProductGrantBackfillPreservesOptionsAndExistingRuns`
- `rtk_account_manager/internal/store`: `TestLegacyProductGrantBackfillRejectsCorruptExistingDigest`
- `rtk_account_manager/internal/store`: `TestLegacyProductGrantBackfillRejectsMismatchedSnapshotAtomically`
- `rtk_account_manager/internal/store`: `TestLegacyShadowOnlyProductMetadataEditDoesNotRequireLiveCatalog`
- `rtk_account_manager/internal/store`: `TestLifecycleMetricsAggregatesQueueAndOperationHealth`
- `rtk_account_manager/internal/store`: `TestLifecycleProjectionDoesNotOverwriteNewerActivity`
...
- `rtk_account_manager/internal/store`: `TestMergeUserDeviceMetadataPreservesServiceFacts`
- `rtk_account_manager/internal/store`: `TestMergeUserDeviceMetadataRejectsReservedKeys`
...
- `rtk_account_manager/internal/store`: `TestPlatformServiceManifestValidation/unversioned`
- `rtk_account_manager/internal/store`: `TestPlatformServiceManifestValidation`
...
- `rtk_account_manager/internal/store`: `TestProductServiceApplyCompletesEmptyFrozenJobAndKeepsTerminalState`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyFreezesMoreThan250DevicesAndRequiresAppliedReceipt`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyReadModelRequiresExactAppliedReceipt`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRejectsChangedGrantAndMembership`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/empty_options`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/invalid_revision`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/invalid_state`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/missing_actor`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/other_cloud_cannot_admit`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/other_cloud_cannot_finish`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/other_cloud_cannot_item`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/other_cloud_cannot_job`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/other_cloud_cannot_page`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/other_cloud_cannot_preview`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/unknown_batch`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/wrong_operation`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants/wrong_target_options`
- `rtk_account_manager/internal/store`: `TestProductServiceApplyRemovalRejectsChangedOrUntrustedDeviceGrants`
- `rtk_account_manager/internal/store`: `TestProductServiceGrantValidationPreservesHistoricalSubset/current_MQTT_subset`
- `rtk_account_manager/internal/store`: `TestProductServiceGrantValidationPreservesHistoricalSubset/current_dependent_option`
- `rtk_account_manager/internal/store`: `TestProductServiceGrantValidationPreservesHistoricalSubset/dependent_option_missing_MQTT`
- `rtk_account_manager/internal/store`: `TestProductServiceGrantValidationPreservesHistoricalSubset/duplicate_entitlement`
- `rtk_account_manager/internal/store`: `TestProductServiceGrantValidationPreservesHistoricalSubset/empty_entitlement`
- `rtk_account_manager/internal/store`: `TestProductServiceGrantValidationPreservesHistoricalSubset/legacy_option_without_MQTT`
- `rtk_account_manager/internal/store`: `TestProductServiceGrantValidationPreservesHistoricalSubset/option_absent_from_Product_grant`
- `rtk_account_manager/internal/store`: `TestProductServiceGrantValidationPreservesHistoricalSubset`
...
- `rtk_account_manager/internal/store`: `TestProductServiceSelectionRequiresRegisteredFoundationAndDependencies/unregistered`
- `rtk_account_manager/internal/store`: `TestProductServiceSelectionRequiresRegisteredFoundationAndDependencies`
...
- `rtk_account_manager/internal/store`: `TestProvisionOutboxPinsProductGrantAcrossReplayAndRevision`
- `rtk_account_manager/internal/store`: `TestProvisionUsesClaimTokenPinAfterProductRevision`
- `rtk_account_manager/internal/store`: `TestProvisionUsesIssuedFactoryRunPinAfterProductRevision`
...
- `rtk_account_manager/internal/store`: `TestRegisteredOptionsPinProductRunAndFactoryGrant`
...
- `rtk_account_manager/internal/store`: `TestServicePublicationRequiresReadyRevisionAndDoesNotRollBackOnOldHeartbeat`
...
- `rtk_account_manager/internal/usercache`: `TestRedisCacheRoundTripsPlatformAndEndUserProjections`
...
- `rtk_account_manager/internal/usercache`: `TestRetireTenantIdentityPreservesOtherCacheDomains`
- `rtk_account_manager/internal/usercache`: `TestRetireTenantIdentityReportsIncompleteCleanup/decode`
- `rtk_account_manager/internal/usercache`: `TestRetireTenantIdentityReportsIncompleteCleanup/delete`
- `rtk_account_manager/internal/usercache`: `TestRetireTenantIdentityReportsIncompleteCleanup/global-auth`
- `rtk_account_manager/internal/usercache`: `TestRetireTenantIdentityReportsIncompleteCleanup/scan`
- `rtk_account_manager/internal/usercache`: `TestRetireTenantIdentityReportsIncompleteCleanup`
...
- `rtk_account_manager/internal/worker/inbox`: `TestEntitlementSnapshotResultsCompleteOperationWithoutMetadataProjection/failure`
- `rtk_account_manager/internal/worker/inbox`: `TestEntitlementSnapshotResultsCompleteOperationWithoutMetadataProjection/success`
- `rtk_account_manager/internal/worker/inbox`: `TestEntitlementSnapshotResultsCompleteOperationWithoutMetadataProjection`
- `rtk_account_manager/internal/worker/inbox`: `TestLifecycleResultTransitionsPinActivityGeneration/deactivate_failed`
- `rtk_account_manager/internal/worker/inbox`: `TestLifecycleResultTransitionsPinActivityGeneration/deactivate_succeeded`
- `rtk_account_manager/internal/worker/inbox`: `TestLifecycleResultTransitionsPinActivityGeneration/provision_failed`
- `rtk_account_manager/internal/worker/inbox`: `TestLifecycleResultTransitionsPinActivityGeneration/provision_succeeded`
- `rtk_account_manager/internal/worker/inbox`: `TestLifecycleResultTransitionsPinActivityGeneration`
